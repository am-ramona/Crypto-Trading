...
export default function Highchart () {
  ...
  function addPopupEvents (chart) {
    var closePopupButtons = document.querySelectorAll (
            ...
            events: {
              ...
              showPopup: function (event) {
                if (!this.indicatorsPopupContainer) {
                  this.indicatorsPopupContainer = document.getElementsByclass (
                    'highcharts-popup-indicators'
                  )[0];
                }

                if (!this.annotationsPopupContainer) {
                  this.annotationsPopupContainer = document.getElementsByclass (
          ...
          <div className="highcharts-menu-wrapper">
            <ul className="highcharts-stocktools-toolbar stocktools-toolbar">
              ...
              <li className="highcharts-label-annotation" title="Simple shapes">
                ...
                <span className="highcharts-submenu-item-arrow highcharts-arrow-right" />
                <ul className="highcharts-submenu-wrapper">
                  ...
                  >
                    <span className="highcharts-menu-item-btn" />
                    <span className="highcharts-menu-item-title">
                      Rectangle
                    </span>
                  </li>
              ...
              <li
                className="highcharts-current-price-indicator right"
                title="Current Price Indicators"
              >
                <span className="highcharts-menu-item-btn" />
              </li>
              <li
                className="highcharts-toggle-annotations right"
