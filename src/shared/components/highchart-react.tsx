...
// const HighchartReact = (props: HighchartsReact.Props) => {
...
// import {_, formatNumber, getHours, getTime} from "./scripts";

// export default function HighchartReact({options, data, showAxis = true, displayMax = false}) {
...
//   useEffect(() => {
//     console.log(chartComponentRef.current?.chart); 
//   }, []);
